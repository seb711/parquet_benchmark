...
static const char *allocation_tag = "parquet";
static const char *s3_bucket = "sauerwein-public-bi-benchmark-parquet";
static const char *s3_region = "us-east-1";
...
inline void s3_init(std::size_t total_requests, long prealloc, std::size_t threads, uint64_t (*decompressPart)(long)) {
